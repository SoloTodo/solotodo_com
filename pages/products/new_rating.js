              ...
              <div className="row">
                ...
                <div className="col-12">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><Link href={`/products?id=${product.id}&slug=${product.slug}`} as={`/products/${product.id}-${product.slug}`}>{product.name}</Link></li>
                  ...
                  <div className="content-card">
                    <table className="table">
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="file" name="purchase_proof" className="form-control-file" onChange={this.handleFileChange} />
...
export default withRouter(NewProductRating)