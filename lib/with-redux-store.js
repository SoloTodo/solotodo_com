...
export default App => {
  return class AppWithRedux extends React.Component {
    static async getInitialProps(appContext) {
      ...
      // Preferences
      const { preferredCountry, preferredStores, preferredStoresLastUpdated } = parseCookies(appContext.ctx);

      const cleanedPreferredStoreIds = preferredStores ? JSON.parse(preferredStores) : null;
      ...
      const initialState = {
        ...
        preferredStores: cleanedPreferredStoreIds,
