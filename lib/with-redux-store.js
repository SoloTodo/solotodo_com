...
export default App => {
  return class AppWithRedux extends React.Component {
    static async getInitialProps(appContext) {
      ...
      // Preferences
      const { preferredCountryId, preferredStoreIds, preferredStoresLastUpdated, preferredExcludeRefurbished } = parseCookies(appContext.ctx);
      ...
      const cleanedPreferredExcludeRefurbished = preferredExcludeRefurbished ? JSON.parse(preferredExcludeRefurbished) : null;
      ...
      const initialState = {
        ...
        preferredExcludeRefurbished: cleanedPreferredExcludeRefurbished
      };
